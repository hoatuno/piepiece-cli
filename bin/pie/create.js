...
rl.question("Enter the project name: ", (answer) => {
  ...
  switch (framework) {
    case "react": {
      ...
      shell
        .cat(piepieceCliPath + "pie/react/piece_vue.jsx")
        .to("src/piece_vue.jsx");
    ...
    case "vue": {
      ...
      shell
        .cat(piepieceCliPath + "pie/vue/vite.config.js")
        .to("vite.config.js");
      ...
      shell
        .cat(piepieceCliPath + "pie/vue/routers/piece_vue.jsx")
        .to("src/routers/piece_vue.jsx");
      shell.exec("yarn add @originjs/vite-plugin-federation --save --dev");
      shell.exec("yarn link piepiece-cli");
